    ...
    <>
      <div className="who_we_are section" id="about">
        ...
        <p>
          ...
          Associate lawyers, Chartered Accountants and Company Secretary in all
          states and union territories of India and other countries. We can
          cater to all corporate legal, regulatory, accounting, compliances and
          dispute resolution requirements of our clients across the country.
        </p>
        ...
        <p>
          ...
          help business performance, leverage IT investments, protect financial
          assets, manage risk, and boost market confidence. Through our diverse
          capabilities and industry knowledge, we help companies meet today’s
          challenges, such as dramatic disruption and accelerated technology
          advancements, while charting a path to growth.
        </p>

        <p>
          Our focus is to mitigate risk of legal matters and to follow the
          regulations/ policy of the government. We collaborate with the client
          to highlight legal risks and advise steps and solutions to mitigate
          these to achieve the business objectives.
        </p>
